...
struct PlayerInputState {
    uint16_t current_actions{}; ///< Masque binaire des actions actuelles.
    float dir_x{0.0f};          ///< Direction X du mouvement (normalisée).
    float dir_y{0.0f};          ///< Direction Y du mouvement (normalisée).
};
