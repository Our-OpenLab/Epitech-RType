...
private:
  ...
  GameState<PacketType> game_state_;  ///< Holds the state of the game, including players and lobbies.
  ...
  ServiceContainer service_container_; ///< Service container for managing application services.
