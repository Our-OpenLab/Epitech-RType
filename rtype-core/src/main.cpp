...
int main()
{
 ...
 // rtype::MainServer<network::MyPacketType> game_server(4242, 4243, "postgresql://postgres:SNgBp4fVJn@my-postgres-postgresql.default.svc.cluster.local:5432/mydb");

  rtype::MainServer<network::MyPacketType> game_server(4242, 4243, "postgresql://postgres:SNgBp4fVJn@localhost:5432/mydb");
